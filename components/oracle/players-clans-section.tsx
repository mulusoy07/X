...
const players: Player[] = [
  { rank: 1, name: "Thoketh914", clan: "BrutalGuard", nation: "karus", playerClass: "priest", monthlyNP: 18200 },
  { rank: 2, name: "Gorus424", clan: "BrutalGuard", nation: "karus", playerClass: "warrior", monthlyNP: 15600 },
  { rank: 3, name: "Cedion252", clan: "SilverEmpire", nation: "human", playerClass: "rogue", monthlyNP: 14300 },
  { rank: 4, name: "Arthion93", clan: "SilverForce", nation: "human", playerClass: "mage", monthlyNP: 12100 },
  { rank: 5, name: "Kragath680", clan: "ShadowForce", nation: "karus", playerClass: "rogue", monthlyNP: 10800 },
]

const clans: Clan[] = [
  { rank: 1, name: "IronLegion", leader: "User1", members: 48, points: 1560000 },
  { rank: 2, name: "ShadowPact", leader: "User2", members: 45, points: 1420000 },
  { rank: 3, name: "PhoenixGuard", leader: "User3", members: 42, points: 1280000 },
  { rank: 4, name: "FrostBorn", leader: "User4", members: 40, points: 1150000 },
  { rank: 5, name: "StormRiders", leader: "User5", members: 38, points: 980000 },
]
...
export function PlayersClansSection() {
                ...
                <div className="relative flex items-stretch">
                  ...
                  <div className="flex-1 flex items-center px-3 gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <span className="text-[11px] text-cream-dim truncate block">{player.clan}</span>
                    </div>
                    <div className="text-center min-w-[4rem] shrink-0">
                      <div className="text-[10px] text-cream-dim uppercase tracking-wider font-medium">Aylik NP</div>
                ...
                <div className="relative flex items-stretch">
                  ...
                  <div className="flex-1 flex items-center px-3 gap-3">
                    ...
                    <div className="hidden sm:block text-center min-w-[3rem] shrink-0">
                      <div className="text-[10px] text-cream-dim uppercase tracking-wider font-medium">Uye</div>
                      <div className="text-sm font-bold text-cream">{clan.members}</div>
                    </div>
                    <div className="text-center min-w-[5rem] shrink-0">
                      <div className="text-[10px] text-cream-dim uppercase tracking-wider font-medium">Puan</div>
                      <div className="text-sm font-black bg-gradient-to-r from-gold-400 to-gold-500 bg-clip-text text-transparent">
