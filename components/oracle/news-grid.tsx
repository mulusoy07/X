        ...
        {featuredNews && (
          <article className="rounded-xl overflow-hidden group flex flex-col row-span-3 bg-ink-800/50 border border-line">
            ...
            <div className="p-5 flex-1 flex flex-col">
              <h4 className="font-display text-xl font-bold text-cream group-hover:text-gold-300 transition mt-1 leading-snug">
                {featuredNews.title}
              </h4>
              <p className="text-sm text-cream-dim mt-3 leading-relaxed line-clamp-3">{featuredNews.description}</p>
              <div className="flex items-center gap-4 mt-auto pt-4 text-xs text-cream-dim">
