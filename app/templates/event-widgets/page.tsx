...
import { EventWidgetsShowcase } from "@/components/templates/event-widgets"
    ...
    <div className="min-h-screen bg-ink-950">
      <div className="border-b border-line bg-ink-900/50 backdrop-blur-sm sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-cream">Event Widgets</h1>
            <p className="text-sm text-cream-dim">/components/templates/event-widgets.tsx</p>
          </div>
        </div>
      </div>
      <EventWidgetsShowcase />
    </div>
  )
}
